...
//
// O4b (ADR-29, SRC-D-OTEL-21): resolve_span_edges distils each declared span
...
// ADR-31.D8 hazard class), the surviving edge — hence the whole block's bytes — would flip
// clang≢gcc.
//
